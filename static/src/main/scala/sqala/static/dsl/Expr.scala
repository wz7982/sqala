...
extension [X](x: X)
    def asc(using AsSqlExpr[X], QueryContext): Sort[X] = compileTimeOnly

    def ascNullsFirst(using AsSqlExpr[X], QueryContext): Sort[X] = compileTimeOnly

    def ascNullsLast(using AsSqlExpr[X], QueryContext): Sort[X] = compileTimeOnly

    def desc(using AsSqlExpr[X], QueryContext): Sort[X] = compileTimeOnly

    def descNullsFirst(using AsSqlExpr[X], QueryContext): Sort[X] = compileTimeOnly

    def descNullsLast(using AsSqlExpr[X], QueryContext): Sort[X] = compileTimeOnly
