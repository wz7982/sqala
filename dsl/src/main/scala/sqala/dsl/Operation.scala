...
object UnionOperation:
    ...
    given tupleUnion[LH, LT <: Tuple, RH, RT <: Tuple](using h: UnionOperation[LH, RH], t: UnionOperation[LT, RT]): Aux[LH *: LT, RH *: RT, h.R *: ToTuple[t.R]] = new UnionOperation[LH *: LT, RH *: RT]:
    ...
    given namedTupleUnion[LN <: Tuple, LV <: Tuple, RN <: Tuple, RV <: Tuple](using u: UnionOperation[LV, RV]): Aux[NamedTuple[LN, LV], NamedTuple[RN, RV], NamedTuple[LN, ToTuple[u.R]]] = new UnionOperation[NamedTuple[LN, LV], NamedTuple[RN, RV]]:
        type R = NamedTuple[LN, ToTuple[u.R]]

    given namedTupleAndTupleUnion[LN <: Tuple, LV <: Tuple, RV <: Tuple](using u: UnionOperation[LV, RV]): Aux[NamedTuple[LN, LV], RV, NamedTuple[LN, ToTuple[u.R]]] = new UnionOperation[NamedTuple[LN, LV], RV]:
        type R = NamedTuple[LN, ToTuple[u.R]]
